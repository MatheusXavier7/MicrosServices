package com.microsservices.microsservices.controller;
...
import com.microsservices.microsservices.service.PedidoService;
...
public class PedidoController {
	...
	@Value("${broker.queue.procesamento.name}")
	...
	public String criarPedido(@RequestBody Pedido pedido) {
		...
		return "Pedido salvo e enviado para prcessamento " + pedido.getDescricao();
	}
